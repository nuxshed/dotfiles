;;; doom-bberry-theme.el --- Based on Ian Pan's Wilmersdorf -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Author: nuxsh
...
(defgroup doom-bberry-theme nil
  "Options for the `doom-bberry' theme."
  :group 'doom-themes)

(defcustom doom-bberry-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-bberry-theme
...
(def-doom-theme doom-bberry
  "A dark theme inspired by Ian Pan's Wilmersdorf"

  ;; name        default   256       16
  ((bg         '("#222228" "#222228" nil            ))
   ...
   (-modeline-pad
    (when doom-bberry-padded-modeline
      (if (integerp doom-bberry-padded-modeline) doom-bberry-padded-modeline 4)))
  ...
  (mode-line-evil-normal :foreground base0 :background magenta)
  (mode-line-evil-insert :foreground base0 :background red)
  (mode-line-evil-visual :foreground base0 :background violet)
  (mode-line-evil-motion :foreground base0 :background yellow)
  (mode-line-evil-replace :foreground base0 :background green)
...
;;; doom-bberry-theme.el ends here
