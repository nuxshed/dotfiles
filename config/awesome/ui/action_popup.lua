...
-- Sector data
local sectors_data = {
    { start_angle = -math.pi / 2, end_angle = -math.pi / 2 + math.pi / 4, icon = "crop", callback = function() 
        awful.spawn("scr selectiontoclip")
    end },
    { start_angle = -math.pi / 2 + math.pi / 4, end_angle = 0, icon = "camera", callback = function() 
        awful.spawn("rec /home/$USER/Videos/$(date).mp4")
    end },
    { start_angle = 0, end_angle = math.pi / 4, icon = "lock", callback = function() 
        awful.spawn("loginctl lock-session")
    end },
    { start_angle = math.pi / 4, end_angle = math.pi / 2, icon = "power", callback = function() 
...
action_wibox:buttons(gears.table.join(
